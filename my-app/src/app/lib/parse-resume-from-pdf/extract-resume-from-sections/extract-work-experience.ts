import type { ResumeWorkExperience } from "../../zustand/types";
...
const WORK_EXPERINCE_KEYWORDS_LOWERCASE = ['work','experience','employment','history','job'];
...
export const extractWorkExperience = (sections: ResumeSectionToLines) => {
    ...
    const lines = getSectionLinesByKeywords(
        sections,
        WORK_EXPERINCE_KEYWORDS_LOWERCASE
    );
    ...
    for (const subsectionLines of subsections) {
        ...
        const description = getBulletPointsFromLines(subsectionDescriptionsLines);
