    ...
    <main className="min-h-screen bg-gray-50 text-gray-800">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
              ...
              <p>Get personalized advice to identify your strengths and choose the right path.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
              <h3 className="text-xl font-semibold mb-3">Resume Building</h3>
              <p>Stand out to employers with a professionally crafted resume tailored to your goals.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
              <h3 className="text-xl font-semibold mb-3">Interview Preparation</h3>
              <p>Boost your confidence with mock interviews and targeted feedback from experts.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-800 text-gray-300 py-6">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-sm mt-2">Contact: info@careercompass.com | +91 234567</p>
        </div>
      </footer>
    </main>
  );
